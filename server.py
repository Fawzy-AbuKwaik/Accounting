...
VERIFY_TOKEN = "my_verify_Token_123" # This is simply a variable containing a secret-ish verification string that I choose, when configuring the webhook with Meta, I'll give Meta the same value
